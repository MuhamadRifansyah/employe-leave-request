...
export async function PUT(
  ...
  try {
    ...
    if (name !== undefined) {
      ...
      if (trimmed.length < 2) validationErrors.push("Name must be at least 2 characters");
    ...
    if (department !== undefined) {
      ...
      if (trimmed.length < 2) validationErrors.push("Department must be at least 2 characters");
    ...
    if (position !== undefined) {
      ...
      if (trimmed.length < 2) validationErrors.push("Position must be at least 2 characters");
